        ...
        public static async Task SeedAsync(AppDbContext db, bool reapply = false)
        {
            ...
            var categories = new List<CourseCategory>
            {
                new CourseCategory
                {
                    ...
                    HeroImageFileName = $"{CarCategory.Electric.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.Hatchback.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.LCGC.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.MPV.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.Offroad.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.Sedan.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.SUV.ToString().ToLower()}-hero.svg"
                },
                new CourseCategory
                {
                    Id = Guid.NewGuid(),
                    ...
                    HeroImageFileName = $"{CarCategory.Truck.ToString().ToLower()}-hero.svg"
                }
            };
